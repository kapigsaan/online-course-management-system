...
class Migration_Insert_homework extends CI_Migration {

	public function up(){
		if(!$this->db->table_exists("homework")){
		...
		$this->dbforge->create_table("homework");
		}
	}

	public function down(){
		if($this->db->table_exists("homework")){
			$this->dbforge->drop_table("homework");
		}
	}
}